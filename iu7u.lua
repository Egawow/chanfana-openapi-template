...
Fix (Auto Heal) ให้รวดเร็ว ยิ่งขึ้น 0.1 เเละ หยุด Battle ชั่วคราวเพื่อ Heal

Fix เปิด Auto Heal ทำไมไม่ Heal วะ



หรือว่า เช็ค ว่าถึงเทิร์นของตัวละครเรารึยัง เเละ ถ้า Heal เเล้วเลือดไม่เพิ่มขึ้น ให้ Heal จนกว่า เลือด จะเพิ่มขึ้น
